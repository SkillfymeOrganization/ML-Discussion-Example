...
# Plot normal logs
normal_logs = df_test[df_test["is_anomaly"] == "✅ Normal"]
plt.scatter(normal_logs["timestamp"], normal_logs["level_score"],
            c="green", label="Normal", alpha=0.6)

# Plot anomalies
plt.scatter(anomalies["timestamp"], anomalies["level_score"],
            c="red", label="Anomaly", alpha=0.8, marker="x")

plt.title("Log Timeline with AI-detected Anomalies")
plt.xlabel("Timestamp")
plt.ylabel("Log Level (numeric)")
plt.legend()
plt.xticks(rotation=45)
plt.tight_layout()
plt.show()

# === Step 6: Show Final Logs with Flags ===
